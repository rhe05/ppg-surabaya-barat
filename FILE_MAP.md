...
| `13_AppsScript/Code.js` → `serverRegisterGuru` | Daftar mandiri Guru (tab "Daftar" di layar login) — verifikasi HANYA lewat cocok nama (case-insensitive) ke sheet `guru`, tanpa admin pilih dropdown | Fitur Daftar Guru |
