...
- `setDataMasterFocus_` (Script_Main.html) generik lewat `window.DATA_MASTER_SECTIONS_` (guru/generus/pendidikan/siklus) — buka Daftar salah satu section otomatis sembunyikan 3 section lainnya.
